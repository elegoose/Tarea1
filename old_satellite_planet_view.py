...
if __name__ == '__main__':
    ...
    while not glfw.window_should_close(window):
        ...
        #glUniformMatrix4fv(glGetUniformLocation(planetsPipeline.shaderProgram, 'transform'), 1, GL_TRUE, tr.matmul([tr.uniformScale(proportion * 0.05),tr.translate(posx_sat, posy_sat, 0)]))
        #planetsPipeline.drawShape(gpuPlanetTrail)
        #satelliteOrbit.transform = tr.matmul([tr.uniformScale(proportion * 0.1),tr.translate(posx,posy, 0)])
